...
describe("ImmutableProperty class", function() {
    ...
    describe("Test the construction and options", function() {
        ...
        it("instantiates a valid ImmutableProperty", function() {
            expect(new ImmutableProperty<string>(STRING_DATA, PROPERTY_NAME))
    ...
    describe("Testing functionality of the class (as a String)", function() {
        ...
        it("uses valueOf to add two ImmutableProperty<string> objects " +
            "together",
        function() {
    ...
    describe("Testing functionality of the class (as a String)", function() {
        ...
        it("uses toString on a numeric ImmutableProperty to get the string " +
            "value",
        function() {
