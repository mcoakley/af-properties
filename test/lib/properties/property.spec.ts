...
abstract class PropertyTester<T>
    extends Property<T, PropertyTesterOptions>
{
        ...
        it("ensures all options have valid values", function() {
            ...
            const testOptions: PropertyTesterOptions = {
                ...
                stopValidationOnInvalid:
                    DEFAULT_PROPERTY_STOP_VALIDATION_ON_INVALID,
                waitInterval: DEFAULT_PROPERTY_WAIT_INTERVAL,
                waitTimeout: DEFAULT_PROPERTY_WAIT_TIMEOUT
            };
            ...
            loadOptions.stopValidationOnInvalid = true;
            testOptions.stopValidationOnInvalid = true;
            testPropertyOption(loadOptions, testOptions);

            loadOptions.waitInterval = 40;
            testOptions.waitInterval = 40;
            testPropertyOption(loadOptions, testOptions);

            loadOptions.waitTimeout = 1000;
            testOptions.waitTimeout = 1000;
            testPropertyOption(loadOptions, testOptions);
        });
    });
